...
const Services: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="py-24 px-8 bg-[var(--color-aether-surface-container-lowest)]/30 relative">
      <div className="max-w-[1440px] mx-auto">
        <h2 className="text-4xl md:text-7xl font-black text-center text-[var(--color-aether-on-surface)] mb-24 services-title tracking-tighter">
          Nuestras Capacidades
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Service Card 1 */}
          <div className="service-card glass-panel rounded-3xl p-10 md:p-12 hover:bg-[var(--color-aether-surface-container-high)] transition-colors duration-500 group border border-white/5 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="w-16 h-16 rounded-2xl bg-[var(--color-aether-surface-container-low)] flex items-center justify-center mb-10 border border-white/5 group-hover:border-[var(--color-aether-surface-tint)] transition-colors relative z-10">
              <span className="material-symbols-outlined text-3xl text-[var(--color-aether-surface-tint)]">psychology</span>
            </div>
            <h3 className="text-3xl font-bold text-[var(--color-aether-on-surface)] mb-6 relative z-10">Agentes de IA</h3>
            <p className="text-lg text-[var(--color-aether-on-surface-variant)] mb-10 relative z-10">Construimos sistemas inteligentes que califican y convierten leads 24/7 sin intervención humana.</p>
            <ul className="space-y-4 text-[var(--color-aether-on-surface)] relative z-10 font-medium">
          ...
          <div className="service-card glass-panel rounded-3xl p-10 md:p-12 hover:bg-[var(--color-aether-surface-container-high)] transition-colors duration-500 group border border-white/5 relative overflow-hidden">
            ...
            <h3 className="text-3xl font-bold text-[var(--color-aether-on-surface)] mb-6 relative z-10">Automatización</h3>
            <p className="text-lg text-[var(--color-aether-on-surface-variant)] mb-10 relative z-10">Optimizamos cada punto de contacto. Sin pasos innecesarios, solo un camino limpio a la conversión.</p>
            <ul className="space-y-4 text-[var(--color-aether-on-surface)] relative z-10 font-medium">
              <li className="flex items-center gap-3">
          ...
          <div className="service-card glass-panel rounded-3xl p-10 md:p-12 hover:bg-[var(--color-aether-surface-container-high)] transition-colors duration-500 group border border-white/5 relative overflow-hidden">
            ...
            <h3 className="text-3xl font-bold text-[var(--color-aether-on-surface)] mb-6 relative z-10">Estrategia</h3>
            <p className="text-lg text-[var(--color-aether-on-surface-variant)] mb-10 relative z-10">Diseñamos funnels de alto rendimiento basados en datos y psicología de conversión.</p>
            <ul className="space-y-4 text-[var(--color-aether-on-surface)] relative z-10 font-medium">
              <li className="flex items-center gap-3">
