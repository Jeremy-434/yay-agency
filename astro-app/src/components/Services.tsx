...
const Services: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="py-10 px-8 bg-[var(--color-aether-surface-container-lowest)]/30 relative">
      <div className="max-w-[1440px] mx-auto">
        <h2 className="text-4xl md:text-7xl font-black text-center text-[var(--color-aether-on-surface)] mb-10 services-title tracking-tighter">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="service-card glass-panel rounded-3xl p-4 md:p-6 hover:bg-[var(--color-aether-surface-container-high)] transition-colors duration-500 group border border-white/5 relative overflow-hidden">
            ...
            <ul className="space-y-4 text-[var(--color-aether-on-surface)] relative z-10 font-medium mb-10">
